      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24">
          <form onSubmit={(e) => {
            ...
            const subject = `Ny melding fra ${name} (Økonomiakademiet)`;
            const body = `Navn: ${name}\nE-post: ${email}\n\nMelding:\n${message}`;

            window.location.href = `mailto:okonomiakademietub@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
          }} className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8" autoComplete="off">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                id="name"
                autoComplete="off"
                className="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-logo-blue sm:text-sm sm:leading-6"
                required
              />
            </div>
            <div className="sm:col-span-2">
